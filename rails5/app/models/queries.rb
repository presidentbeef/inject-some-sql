Queries = [
  {
    ...
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/Calculations.html#method-i-calculate",
...
Never pass user input directly to `destroy_all`.
...

  {
    :action => :exists,
    :name => "Exists? Method",
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/FinderMethods.html#method-i-exists-3F",
...
The `from` method accepts arbitrary SQL.
...

  {
    :action => :joins,
    :name => "Joins Method",
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/QueryMethods.html#method-i-joins",
...

  {
    ...
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/QueryMethods.html#method-i-lock",
...
The `lock` method and the `:lock` option for `find` and related methods accepts a SQL fragment.
...

  {
    :action => :pluck,
    :name => "Pluck Method",
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/Calculations.html#method-i-pluck",
...
However, the return result will still be an array of values from a single column.
...

  {
    :action => :reorder,
    :name => "Reorder Method",
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/QueryMethods.html#method-i-reorder",
...

  {
    ...
    :name => 'Select Method',
    :link => "http://api.rubyonrails.org/v5.0.0.1/classes/ActiveRecord/QueryMethods.html#method-i-select",
